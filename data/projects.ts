...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2025",
    description:
      "Jeu idle tower defense en React : un axolotl archer défend son château contre des vagues de squelettes. Game loop via requestAnimationFrame, système d'upgrades, format mobile paysage.",
    context:
      "Projet de game dev expérimental pour explorer les mécaniques de jeu idle en React pur — sans moteur, sans canvas. L'objectif : boucle de gameplay fluide à 60fps, layout mobile-first.",
    solution:
    ...
    githubUrl: "https://github.com/kevingaga/idle-game-jsx",
  },
];
