...
export const translations = {
  en: {
    ...
    about: {
      ...
      galaxy: {
        kicker: "Stellar map of skills",
        subtitle:
          "Six clusters, six colours: each gathers its skills under a nebula. Where the clouds overlap, domains meet. Click a planet to open its card.",
        hint: "Click a planet · drag a cluster name · scroll to zoom",
        links_title: "Links · constellations",
        reset: "Recenter",
        close: "Close",
        menu: "Legend & guide",
        legend_title: "Legend",
        clusters_label: "Clusters",
        sizes_label: "Planet size = mastery",
        levels: {
          lvl0: "Interest",
          lvl1: "Beginner",
          lvl2: "Intermediate",
  ...
  fr: {
    ...
    about: {
      ...
      galaxy: {
        kicker: "Carte stellaire des savoirs",
        subtitle:
          "Six amas, six couleurs : chacun regroupe ses compétences sous une nébuleuse. Là où les nuages se chevauchent, les domaines se rejoignent. Clique une planète pour ouvrir sa fiche.",
        hint: "Cliquer une planète · glisser un nom d'amas · molette pour zoomer",
        links_title: "Liens · constellations",
        reset: "Recentrer",
        close: "Fermer",
        menu: "Légende & guide",
        legend_title: "Légende",
        clusters_label: "Amas",
        sizes_label: "Taille des planètes = maîtrise",
        levels: {
          lvl0: "Intérêt",
          lvl1: "Débutant",
          lvl2: "Intermédiaire",
